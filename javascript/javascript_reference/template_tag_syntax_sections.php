...
<pre>
<span class='line-number-all line-number-justify-right-one'></span>&lt;p id='testId'&gt;&lt;b&gt;Fail&lt;/b&gt; (no support): The web browser does not recognize the JavaScript template tag syntax. The web browser does not support the JavaScript template tag syntax.&lt;/p&gt;<span class='comment'>&lt;!-- Hard code Fail because web browser no support error stops JavaScript execution. --&gt;</span>
...
<span class='line-number-all line-number-justify-right-one'></span>function implementationTestTemplateTagName(dummyTemplateLiteralStringLiterals){
<span class='line-number-all line-number-justify-right-one'></span> var element = document.getElementById(&quot;testId&quot;),
<span class='line-number-all line-number-justify-right-one'></span>  substitutionOne = &quot;def&quot;,
<span class='line-number-all line-number-justify-right-one'></span>  numberLiteralOne = 1,
<span class='line-number-all line-number-justify-right-one'></span>  numberLiteralTwo = 2,
<span class='line-number-all line-number-justify-right-one'></span>  substitutionTwo = numberLiteralOne + numberLiteralTwo,
<span class='line-number-all'></span>  substitutionThree = &quot;mno&quot;;
<span class='line-number-all'></span> function capabilityTestTemplateTagName(templateLiteralStringLiterals, templateLiteralSubstitutionOne, templateLiteralSubstitutionTwo, templateLiteralSubstitutionThree){
<span class='line-number-all'></span>  return templateLiteralStringLiterals[0] + templateLiteralSubstitutionOne + templateLiteralStringLiterals[1] + templateLiteralSubstitutionTwo + templateLiteralStringLiterals[2] + templateLiteralSubstitutionThree + templateLiteralStringLiterals[3];
<span class='line-number-all'></span> }
<span class='line-number-all'></span> var templateTagStringOutput = capabilityTestTemplateTagName`abc &dollar;{substitutionOne} ghi &dollar;{substitutionTwo} jkl &dollar;{substitutionThree} pqr`;
<span class='line-number-all'></span> if ((typeof templateTagStringOutput === &quot;string&quot;) &amp;&amp; (templateTagStringOutput === &quot;abc def ghi 3 jkl mno pqr&quot;)){
<span class='line-number-all'></span>  element.innerHTML = &quot;&lt;b&gt;Pass&lt;/b&gt; (at least partial/possibly full support): The web browser recognizes the JavaScript template tag syntax, and supports at least one template tag syntax capability. The web browser at least partially/possibly fully supports the JavaScript template tag syntax. Positive determination of full web browser support is beyond the scope of this test.&quot;;
<span class='line-number-all'></span> } else {
<span class='line-number-all'></span>  element.innerHTML = &quot;&lt;b&gt;Pass/Fail&lt;/b&gt; (partial support): The web browser recognizes the JavaScript template tag syntax, but does not support at least one template tag syntax capability. The web browser partially supports the JavaScript template tag syntax.&quot;;
<span class='line-number-all'></span> }
<span class='line-number-all'></span>}
<span class='line-number-all'></span>implementationTestTemplateTagName`dummy template literal`;

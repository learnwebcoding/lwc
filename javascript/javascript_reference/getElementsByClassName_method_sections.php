...
<span class='line-number-all line-number-justify-right-one'></span>if (document.getElementsByClassName){
<span class='line-number-all line-number-justify-right-one'></span> var elements = document.getElementsByClassName(&quot;test-class&quot;);
...
<span class='line-number-all line-number-justify-right-one'></span>  document.write(&quot;&lt;p&gt;&lt;b&gt;Pass/Fail&lt;/b&gt; (partial support): The web browser recognizes the JavaScript &lt;code&gt;getElementsByClassName()&lt;/code&gt; method, but does not support at least one &lt;code&gt;getElementsByClassName()&lt;/code&gt; method capability. The web browser partially supports the JavaScript &lt;code&gt;getElementsByClassName()&lt;/code&gt; method.&lt;/p&gt;&quot;);
<span class='line-number-all'></span> }
<span class='line-number-all'></span>} else {
<span class='line-number-all'></span> document.write(&quot;&lt;p&gt;&lt;b&gt;Fail&lt;/b&gt; (no support): The web browser does not recognize the JavaScript &lt;code&gt;getElementsByClassName()&lt;/code&gt; method. The web browser does not support the JavaScript &lt;code&gt;getElementsByClassName()&lt;/code&gt; method.&lt;/p&gt;&quot;);
<span class='line-number-all'></span>}

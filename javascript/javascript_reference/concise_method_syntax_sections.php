...
<pre>
<span class='line-number-all line-number-justify-right-one'></span>&lt;p id='testId'&gt;&lt;b&gt;Fail&lt;/b&gt; (no support): The web browser does not recognize the JavaScript concise method syntax. The web browser does not support the JavaScript concise method syntax.&lt;/p&gt;<span class='comment'>&lt;!-- Hard code Fail because web browser no support error stops JavaScript execution. --&gt;</span>
...
<span class='line-number-all line-number-justify-right-one'></span> conciseMethod(){
...
<span class='line-number-all line-number-justify-right-one'></span> }
<span class='line-number-all line-number-justify-right-one'></span>}
<span class='line-number-all'></span>objectLiteral.conciseMethod();

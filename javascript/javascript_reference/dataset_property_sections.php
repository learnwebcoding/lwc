...
<pre>
<span class='line-number-all line-number-justify-right-one'></span>&lt;p id='testId' data-attributename='attributeValue'&gt;&lt;/p&gt;
...
<span class='line-number-all line-number-justify-right-one'></span>if (element.dataset){
<span class='line-number-all line-number-justify-right-one'></span> if (element.dataset.attributename === &quot;attributeValue&quot;){
...
<span class='line-number-all line-number-justify-right-one'></span>  document.write(&quot;&lt;p&gt;&lt;b&gt;Pass/Fail&lt;/b&gt; (partial support): The web browser recognizes the JavaScript &lt;code&gt;dataset&lt;/code&gt; property, but does not support at least one &lt;code&gt;dataset&lt;/code&gt; property capability. The web browser partially supports the JavaScript &lt;code&gt;dataset&lt;/code&gt; property.&lt;/p&gt;&quot;);
<span class='line-number-all'></span> }
<span class='line-number-all'></span>} else {
<span class='line-number-all'></span> document.write(&quot;&lt;p&gt;&lt;b&gt;Fail&lt;/b&gt; (no support): The web browser does not recognize the JavaScript &lt;code&gt;dataset&lt;/code&gt; property. The web browser does not support the JavaScript &lt;code&gt;dataset&lt;/code&gt; property.&lt;/p&gt;&quot;);
<span class='line-number-all'></span>}

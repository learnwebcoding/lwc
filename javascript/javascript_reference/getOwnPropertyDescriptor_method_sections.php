...
<pre>
<span class='line-number-all line-number-justify-right-one'></span>&lt;p id='testId'&gt;&lt;b&gt;Fail&lt;/b&gt; (no support): The web browser does not recognize the JavaScript &lt;code&gt;getOwnPropertyDescriptor()&lt;/code&gt; method. The web browser does not support the JavaScript &lt;code&gt;getOwnPropertyDescriptor()&lt;/code&gt; method.&lt;/p&gt;<span class='comment'>&lt;!-- Hard code Fail because web browser no support error stops JavaScript execution. --&gt;</span>
...
<span class='line-number-all line-number-justify-right-one'></span> propertyOne: &quot;propertyOne value&quot; <span class='comment'>// Data property. Here, property writable, enumerable, and configurable attributes default to boolean true.</span>
<span class='line-number-all line-number-justify-right-one'></span>};
<span class='line-number-all line-number-justify-right-one'></span>if (Object.getOwnPropertyDescriptor){
<span class='line-number-all line-number-justify-right-one'></span> var element = document.getElementById(&quot;testId&quot;);
<span class='line-number-all line-number-justify-right-one'></span> var dataPropertyDescriptor = Object.getOwnPropertyDescriptor(objectLiteral, &quot;propertyOne&quot;);
<span class='line-number-all'></span> if ((dataPropertyDescriptor.value === &quot;propertyOne value&quot;) &amp;&amp; (dataPropertyDescriptor.writable === true) &amp;&amp; (dataPropertyDescriptor.enumerable === true) &amp;&amp; (dataPropertyDescriptor.configurable === true)){

...
<span class='line-number-all line-number-justify-right-one'></span>var testSetIteratorKeys = testSet.keys(); <span class='comment'>// Get reference to set built-in set iterator object called by keys() method. NOTE: keys() method can be considered a generator function. Call keys() generator function. Call returns a Generator object which inherits prototype from Object (window.Generator property does not exist) and is an iterator. Generator object has next() method property. Called by keys(), set iterator object next() method return object value property is set to set element value.</span>
<span class='line-number-all line-number-justify-right-one'></span>var testSetIteratorKeysNextValues = [];
<span class='line-number-all'></span>for (var i = 0; i &lt; testSet.size; i++){ <span class='comment'>// Identical to for (var key of testSet.keys()){console.log(key);}. 1.) &quot;a&quot;, 2.) &quot;b&quot;, 3.) &quot;c&quot;.</span>
<span class='line-number-all'></span> testSetIteratorKeysNextValues[i] = testSetIteratorKeys.next().value;
<span class='line-number-all'></span>}
<span class='line-number-all'></span>if (testSet.keys){
<span class='line-number-all'></span> var element = document.getElementById(&quot;testId&quot;);
<span class='line-number-all'></span> if ((typeof testSetIteratorKeys === &quot;object&quot;) &amp;&amp; testSetIteratorKeys instanceof Object &amp;&amp; Object.prototype.isPrototypeOf(testSetIteratorKeys) &amp;&amp; (typeof testSetIteratorKeysNextValues[0] === &quot;string&quot;) &amp;&amp; (testSetIteratorKeysNextValues[0] === &quot;a&quot;) &amp;&amp; (testSetIteratorKeysNextValues[1] === &quot;b&quot;) &amp;&amp; (testSetIteratorKeysNextValues[2] === &quot;c&quot;)){

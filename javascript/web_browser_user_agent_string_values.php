...
/* File: /web_server_root_directory/bom/web_browser_user_agent_string_values.php.
...
$webPage->head_meta_keywords = "web browser, user agent, user-agent, string, value, Internet Explorer, Edge, Firefox, Chrome, Opera, Vivaldi, Safari, SeaMonkey, Flock, Netscape, Mozilla, Netscape Navigator"; // Cap words as if used in sentence. No markup in Keywords.
...
$webPage->body_main_lastReviewed = "Last reviewed/updated: 06 Aug 2024 | Published: 08 Jan 2014 | Status: Active";
$webPage->body_main_toc = include_once "web_browser_user_agent_string_values_toc.php";
$webPage->body_main_sections = include_once "web_browser_user_agent_string_values_sections.php";

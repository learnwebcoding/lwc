 ...
 * Last reviewed/updated: 23 Jul 2020.
...
<!-- End same content in template_download.php. -->
     ...
     <div class='note normal'>
      <ul>
       <li>To download the LWC Home Template, see <a href='/html/template_download.php'>Learn Web Coding Home Template Download (learnwebcoding.com)</a>.</li>
...
<!-- In general, greater than or equal to 24 lines, or for or some other reason. -->
<pre>
...
<!-- End similar content in 4. PHP Template System below and PHP_Template_System_Readme.txt. -->
    ...
    <section>
     ...
     <p>The customized <a href='/stylesheets/bootstrap/v341_cust/bootstrap.css'><span class='filename'>bootstrap.css</span> (learnwebcoding.com)</a> is 52,174 bytes, 2,654 lines, and has <a href='/stylesheets/bootstrap/v341_cust/customized_bootstrap_css_validation_test.html'>2 errors and 66 warnings (learnwebcoding.com)</a> per the W3C CSS Validation Service. To further lighten Bootstrap and to further eliminate some troublesome/invalid Bootstrap styles, <span class='filename'>bootstrap.css</span> was manually edited to remove the readily identifiable unnecessary Bootstrap style rules, not to change any Bootstrap style rules. The manually edited <a href='/stylesheets/bootstrap/v341_cust_then_edit/bootstrap.css'><span class='filename'>bootstrap.css (learnwebcoding.com)</span></a> is 35,046 bytes, 1,711 lines, and has <a href='/stylesheets/bootstrap/v341_cust_then_edit/customized_bootstrap_then_edited_css_validation_test.html'>1 error and 23 warnings (learnwebcoding.com)</a> per the W3C CSS Validation Service. Then <span class='filename'>bootstrap.css</span> was manually edited a second time to remove the unnecessary style rule reported in the error and the final <a href='/stylesheets/bootstrap/v341_cust_then_edit_02/bootstrap.css'><span class='filename'>bootstrap.css</span> (learnwebcoding.com)</a> is 34,873 bytes, 1,705 lines, and is <a href='/stylesheets/bootstrap/v341_cust_then_edit_02/customized_bootstrap_then_edited_02_css_validation_test.html'>valid CSS Level 3 with 23 warnings (learnwebcoding.com)</a> per the W3C CSS Validation Service. As a result of customizing Bootstrap and then manually editing, the Bootstrap style sheet was reduced in size by over 75%, is valid CSS Level 3 (with warnings) per the W3C CSS Validation Service, and only 14 style rules <!-- Excluding the LWC navbar styles. -->were required to supplement/override the remaining troublesome Bootstrap styles.</p>

     <h3><a id='customizingBootstrapJavaScript'></a>2.2. Customizing Bootstrap And The Bootstrap JavaScript</h3>

     <p>The Bootstrap 3.4.1 non-minified JavaScript packaged with bootstrap-3.4.1-dist.zip is <a href='/javascripts/bootstrap/v341_dist/bootstrap.js'><span class='filename'>bootstrap.js</span> (learnwebcoding.com)</a>, which is 70,484 bytes and 2,581 lines. The customized Bootstrap <a href='/javascripts/bootstrap/v341_cust/bootstrap.js'><span class='filename'>bootstrap.js</span> (learnwebcoding.com)</a> is 11,478 bytes and 400 lines. As a result of customizing Bootstrap, the Bootstrap JavaScript was reduced in size by over 80%.</p>
...
body {
  ...
  padding: 0;
    ...
    <section>
     ...
     <p>The Font Awesome implementation requires loading the Font Awesome style sheet <span class='filename'>font-awesome.min.css</span> file. The Bootstrap implementation requires the <code>&lt;meta name='viewport' content='width=device-width, initial-scale=1' /&gt;</code> tag and loading the Bootstrap style sheet <span class='filename'>bootstrap.min.css</span> file, the jQuery JavaScript <span class='filename'>jquery-3.4.1.min.js</span> file, and the Bootstrap JavaScript <span class='filename'>bootstrap.min.js</span> file. The LWC code requires loading the LWC Home sitewide main style sheet <span class='filename'>lwc.min.css</span> file, the LWC Home sitewide dynamically changeable <a href='#lwcHomeToolsIconDropdown'>LWC Home tools icon dropdown (below)</a> style sheet <span class='filename'>print_default.min.css</span> file, and the LWC Home sitewide JavaScript <span class='filename'>library_load_in_body.min.js</span> file. The style sheets are loaded in the <code>&lt;head&gt;&lt;/head&gt;</code> section. So that the LWC Home styles may override the Bootstrap styles, the LWC Home style sheets are placed/loaded after the Bootstrap style sheet. The JavaScripts are not required for the rendering of the web page and, therefore, to speed up the initial rendering of the web page, are placed/loaded at the end of the <code>&lt;body&gt;&lt;/body&gt;</code> section:</p>

<pre>
&lt;!DOCTYPE html&gt;
&lt;html lang='en'&gt;
 &lt;head&gt;
  &lt;title&gt;Learn Web Coding Home Template Explained&lt;/title&gt;<span class='comment'>&lt;!-- No markup in title tags. --&gt;</span>
  &lt;meta charset='UTF-8' /&gt;
  &lt;meta name='Author' content='Steve Taylor' /&gt;
  &lt;meta name='Keywords' content='Learn Web Coding Home, template, explained' /&gt;<span class='comment'>&lt;!-- Cap words as if used in sentence. No markup in Keywords. --&gt;</span>
  &lt;meta name='Description' content='An explanation of the Learn Web Coding Home Template.' /&gt;<span class='comment'>&lt;!-- Sentence and/or structured data less than 160 char per Google. No markup in Description. --&gt;</span>
 ...
 &lt;body&gt;
  ...
  <b>&lt;script src='https://code.jquery.com/jquery-3.4.1.min.js'&gt;&lt;/script&gt;
...
&lt;body&gt;
 ...
 <b>&lt;header&gt;</b>
  &lt;nav class='lwc-navbar'&gt;<span class='comment'>&lt;!-- Open LWC navbar HTML. --&gt;</span>
   ...
  &lt;/nav&gt;<span class='comment'>&lt;!-- Close LWC navbar HTML. --&gt;</span>

  &lt;nav class='navbar navbar-inverse navbar-static-top'&gt;<span class='comment'>&lt;!-- Open LWC Bootstrap navbar HTML. --&gt;</span>
   ...
  &lt;/nav&gt;<span class='comment'>&lt;!-- Close LWC Bootstrap navbar HTML. --&gt;</span>

  &lt;noscript class='noscript'&gt;
   ...
  &lt;/noscript&gt;

  &lt;nav&gt;<span class='comment'>&lt;!-- Open LWC Home breadcrumbs navigation HTML. --&gt;</span>
   ...
  &lt;/nav&gt;<span class='comment'>&lt;!-- Close LWC Home breadcrumbs navigation HTML. --&gt;</span>

  &lt;script&gt;<span class='comment'>/* Open LWC Home breadcrumbs navigation JavaScript. */</span>
   ...
  &lt;/script&gt;<span class='comment'>&lt;!-- Close LWC Home breadcrumbs navigation JavaScript. --&gt;</span>
...
<pre>
&lt;header&gt;
 <b>&lt;nav class='lwc-navbar'&gt;<span class='comment'>&lt;!-- Open LWC navbar HTML. --&gt;</span><span class='comment'>&lt;!-- NOTE: Loading lwc.css in LWC Blog/Forums causes issues. Therefore, to avoid loading lwc.css in LWC Blog/Forums, place styles for LWC navbar at bottom of bootstrap.css, not in lwc.css. --&gt;</span>
  &lt;div class='container-fluid'&gt;<span class='comment'>&lt;!-- container-fluid from Bootstrap. --&gt;</span>
  ...
  &lt;/div&gt;<span class='comment'>&lt;!-- Close LWC navbar HTML div class='container-fluid'. --&gt;</span>
 &lt;/nav&gt;<span class='comment'>&lt;!-- Close LWC navbar HTML. --&gt;</span></b>
...
<pre>
a { <s>color: #005a9c;</s> text-decoration: none; } <span class='comment'>/* From normal hyperlinks below. */</span>
a:hover { <s>color: #000; text-decoration: underline;</s> } <span class='comment'>/* From normal hyperlinks below. */</span>
a:focus { <s>outline: thin dotted invert;</s> } <span class='comment'>/* From normal hyperlinks below. */</span>
...
<span class='comment'>/* Supplement/override Bootstrap styles. */</span>
.container-fluid { max-width: 1170px; } <span class='comment'>/* Content. */</span>
</pre>
...
&lt;header'&gt;
 ...
 <b>&lt;nav class='navbar navbar-inverse navbar-static-top'&gt;<span class='comment'>&lt;!-- Open LWC Bootstrap navbar HTML. --&gt;</span><span class='comment'>&lt;!-- navbar-static-top aligns navbar-right content flush to right edge and removes border-top. --&gt;</span>
  &lt;div class='container-fluid'&gt;<span class='comment'>&lt;!-- container-fluid from Bootstrap. --&gt;</span>
   ...
   &lt;div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'&gt;
    ...
    &lt;/ul&gt;
   &lt;/div&gt;
  &lt;/div&gt;<span class='comment'>&lt;!-- Close LWC Bootstrap navbar HTML div class='container-fluid'. --&gt;</span>
 &lt;/nav&gt;<span class='comment'>&lt;!-- Close LWC Bootstrap navbar HTML. --&gt;</span></b>
...
<span class='comment'>/* Supplement/override Bootstrap styles. */</span>
.container-fluid { max-width: 1170px; } <span class='comment'>/* Content. */</span>
.dropdown-menu { min-width: 0; border: 0; padding: 0; } <span class='comment'>/* Bootstrap navbar More dropdown. */</span>
.dropdown-menu > li > a { line-height: 20px; background-color: #000; color: #fff; padding: 10px 15px; } <span class='comment'>/* Bootstrap navbar More dropdown hyperlinks. */</span>
.dropdown-menu > li > a:hover { background-color: #333; color: #fff; } <span class='comment'>/* Bootstrap navbar More dropdown hyperlinks. */</span>
.dropdown-menu > li > a:focus { outline: 0; } <span class='comment'>/* Bootstrap navbar More dropdown hyperlinks. */</span>
.navbar { min-height: 0; border: 0; margin-bottom: 0; } <span class='comment'>/* Bootstrap navbar. */</span>
.navbar-brand { font-family: &quot;courier new&quot;, courier, monospace; font-size: 1.5em; font-weight: bold; } <span class='comment'>/* LWC logo in Bootstrap navbar. */</span>
.navbar-inverse { background-color: #000; } <span class='comment'>/* Bootstrap navbar. */</span>
.navbar-inverse .navbar-brand { color: #fff; } <span class='comment'>/* LWC logo in Bootstrap navbar. */</span>
.navbar-inverse .navbar-brand:focus { outline: 0; } <span class='comment'>/* LWC logo in Bootstrap navbar. */</span>
.navbar-inverse .navbar-nav > li > a { color: #fff; } <span class='comment'>/* Bootstrap navbar hyperlinks. */</span>
.navbar-inverse .navbar-nav > li > a:hover { background-color: #333; } <span class='comment'>/* Bootstrap navbar hyperlinks. */</span>
.navbar-inverse .navbar-nav > li > a:focus { outline: 0; } <span class='comment'>/* Bootstrap navbar hyperlinks. */</span>
.navbar-inverse .navbar-nav > .open > a:hover { background-color: #333; } <span class='comment'>/* Bootstrap navbar More dropdown. More itself, not the dropdown. */</span>
</pre>
...
&lt;header'&gt;
 ...
 <b>&lt;noscript class='noscript'&gt;
  ...
  &lt;/div&gt;<span class='comment'>&lt;!-- Close noscript section div class='container-fluid'. --&gt;</span>
 &lt;/noscript&gt;</b>
...
&lt;/header&gt;
     ...
     <p>The <code>div</code> type selector is not assigned author styles. The <code>noscript</code> type selector and the <code>.noscript</code> and <code>.container-fluid</code> class selectors are assigned author styles. The Bootstrap <code>.container-fluid</code> class selector styles are defined in the Bootstrap style sheet <a href='/stylesheets/bootstrap/bootstrap.css'><span class='filename'>bootstrap.css (learnwebcoding)</span></a> file and are too numerous to show. The author style rules that supplement/override Bootstrap styles are indicated:</p>

<!-- Last reviewed/updated: 12 Aug 2016. -->
<pre>
noscript { display: block; }
.noscript { color: #c41e3a; } <span class='comment'>/* IE6+ no support noscript type selector for styling content. Hence, class selector. */</span>
<span class='comment'>/* Supplement/override Bootstrap styles. */</span>
.container-fluid { max-width: 1170px; } <span class='comment'>/* Content. */</span>
</pre>
...
&lt;header&gt;
 ...
 <b>&lt;nav&gt;<span class='comment'>&lt;!-- Open LWC Home breadcrumbs navigation HTML. --&gt;</span>
  &lt;div class='container-fluid'&gt;<span class='comment'>&lt;!-- container-fluid from Bootstrap. --&gt;</span>
   &lt;div id='bcrumbsNavId' class='bcrumbs-nav'&gt;&amp;nbsp;&lt;/div&gt;<span class='comment'>&lt;!-- Content provided by BcrumbsNavUtil.bcrumbsNav(), which is defined immediately below. --&gt;</span>
  &lt;/div&gt;<span class='comment'>&lt;!-- Close LWC Home breadcrumbs navigation HTML div class='container-fluid'. --&gt;</span>
 &lt;/nav&gt;<span class='comment'>&lt;!-- Close LWC Home breadcrumbs navigation HTML. --&gt;</span>
...
.container-fluid { max-width: 1170px; } <span class='comment'>/* Content. */</span>
     ...
     <ul>
      <li>LWC Home breadcrumbs navigation is intended for, but does not require, the following directory/file tree structure:
<pre class='ascii-art'>
...
<span class='line-number-all line-number-justify-right-one'></span>  var bcrumbsNav = document.getElementById(&quot;bcrumbsNavId&quot;);
<span class='line-number-all line-number-justify-right-one'></span>  var bcrumbsNavHtmlString = &quot;&lt;a href='/index.php'&gt;Home&lt;/a&gt;&quot;;
...
<span class='line-number-all line-number-justify-right-one'></span>    bcrumbsNavHtmlString += &quot; &amp;rarr; &lt;a href='&quot; + arguments[i] + &quot;index.php'&gt;&quot; + arguments[i + 1] + &quot;&lt;/a&gt;&quot;;
<span class='line-number-all line-number-justify-right-one'></span>   }
<span class='line-number-all line-number-justify-right-one'></span>  }
<span class='line-number-all'></span>  bcrumbsNav.innerHTML = bcrumbsNavHtmlString;
...
<b>&lt;main&gt;
 &lt;div class='container-fluid'&gt;<span class='comment'>&lt;!-- container-fluid from Bootstrap. --&gt;</span></b>
  &lt;h1&gt;...&lt;/h1&gt;
 ...
 <b>&lt;/div&gt;<span class='comment'>&lt;!-- Close main section div class='container-fluid'. --&gt;</span>
&lt;/main&gt;</b>
...
&lt;main&gt;
 ...
 &lt;/div&gt;<span class='comment'>&lt;!-- Close main section div class='container-fluid'. --&gt;</span>
&lt;/main&gt;
</pre>
...
<!-- Last reviewed/updated: 18 Jun 2016. -->
<pre>
<span class='comment'>/* Supplement/Override Bootstrap Styles (/stylesheets/bootstrap/bootstrap.css) */</span>
.container-fluid { max-width: 100%; }
<span class='comment'>/* Supplement/Override LWC Home Main Style Sheet Styles (/stylesheets/lwc/lwc.css) */</span>
body { color: #333; }
...
<span class='comment'>/* Supplement/Override Bootstrap Styles (/stylesheets/bootstrap/bootstrap.css) */</span>
.container-fluid { max-width: 100%; }
<span class='comment'>/* Supplement/Override LWC Home Styles (/stylesheets/lwc/lwc.css) */</span>
body { color: #333; }
pre, caption, .note, code { background-color: #fff; }
.note code, .note pre { background-color: #fff; }
.toc a { color: #333; }
...
<pre>
a { <s>color: #005a9c;</s> text-decoration: none; } <span class='comment'>/* From normal hyperlinks below. */</span>
a:hover { <s>color: #000;</s> text-decoration: underline; } <span class='comment'>/* From normal hyperlinks below. */</span>
a:focus { <s>outline: thin dotted invert;</s> } <span class='comment'>/* From normal hyperlinks below. */</span> <span class='comment'>/* Focus does not work on intra-page hyperlinks; hence, strike-through. */</span>
.toc a { color: #000; }
...
<pre>
 ...
 <b>&lt;footer&gt;
  &lt;div class='container-fluid'&gt;<span class='comment'>&lt;!-- container-fluid from Bootstrap. --&gt;</span></b>
  ...
  <b>&lt;/div&gt;<span class='comment'>&lt;!-- Close footer section div class='container-fluid'. --&gt;</span>
 &lt;/footer&gt;</b>
...
&lt;footer&gt;
 ...
 &lt;/div&gt;<span class='comment'>&lt;!-- Close footer section div class='container-fluid'. --&gt;</span>
&lt;/footer&gt;
</pre>
...
<pre>
a { <s>color: #005a9c;</s> text-decoration: none; } <span class='comment'>/* From normal hyperlinks below. */</span>
a:hover { color: #000; <s>text-decoration: underline;</s> } <span class='comment'>/* From normal hyperlinks below. */</span>
a:focus { <s>outline: thin dotted invert;</s> } <span class='comment'>/* From normal hyperlinks below. */</span>
...
a { <s>color: #005a9c; text-decoration: none;</s> } <span class='comment'>/* From normal hyperlinks above. */</span>
a:hover { <s>color: #000; text-decoration: underline;</s> } <span class='comment'>/* From normal hyperlinks above. */</span>
a:focus { outline: thin dotted invert; } <span class='comment'>/* From normal hyperlinks above. */</span>
...
table, caption, th, td { border: 1px solid #d7d7d7; }
caption { font-weight: bold; background-color: #efefef; border-bottom: 0; }
a { color: #005a9c; text-decoration: none; } <span class='comment'>/* From normal hyperlinks above. */</span>
a:hover { color: #000; text-decoration: underline; } <span class='comment'>/* From normal hyperlinks above. */</span>
a:focus { outline: thin dotted invert; } <span class='comment'>/* From normal hyperlinks above. */</span>
</pre>
    ...
    <section>
     ...
     <h4><a id='formButtonsBootstrapColors'></a>25.1.1. Bootstrap 3.3.5 - 3.4.x Button Colors</h4>

     <p>For those interested in adding color to the buttons below, the following are the Bootstrap 3.3.5 - 3.4.x button style rules for the <code>color</code>, <code>background-color</code>, and <code>border-color</code> properties in the default, hover, focus, active hover, and active focus states. For an example of the Bootstrap 3.4.x buttons, see <a href='https://getbootstrap.com/docs/3.4/css/#buttons-options'>Bootstrap 3.4 Buttons Options (getbootstrap.com)</a>:

     <table>
      <caption>Bootstrap 3.3.5 - 3.4.x Button Style Rules For The <code>color</code>, <code>background-color</code>, and <code>border-color</code> Properties In The Default, Hover, Focus, Active Hover, And Active Focus States</caption>
      <thead>
       <tr>
        <th>Button Type<br />
         (color)</th>
        ...
        <th>Hover State</th>
        <th>Focus State</th>
        <th>Active Hover And Active Focus States</th>
       </tr>
      </thead>
      <tbody>
       <tr>
...
<!-- Last reviewed/updated: 11 Jun 2017. -->
<pre>
a { <s>color: #005a9c;</s> text-decoration: none; } <span class='comment'>/* From normal hyperlinks above. */</span>
a:hover { color: #000; <s>text-decoration: underline;</s> } <span class='comment'>/* From normal hyperlinks above. */</span>
a:focus { <s>outline: thin dotted invert;</s> } <span class='comment'>/* From normal hyperlinks above. */</span>
...
.btn:hover { text-decoration: none; } <span class='comment'>/* For the a element. */</span>
.btn:focus { background-color: #efefef; outline: 0; border-color: #666; } <span class='comment'>/* For the a element with the href attribute. */</span>
...
h1 {
  ...
  font-weight: normal;
  color: #005a9c;
  <s>margin: 14px 0;</s> <span class='comment'>/* Applied to web page title, not to code in web page title; hence, strike-through. */</span>
}
code {
  font-family: &quot;courier new&quot;, courier, monospace;
...
&lt;/pre&gt;
     ...
     <p>To add line numbers to a block of code having 1 - 9 lines of code, use the <code>span</code> element with the <code>class='line-number-all'</code> attribute:</p>
...
&lt;/pre&gt;
     ...
     <p>To add line numbers to a block of code having 10 - 99 lines of code: 1.) for lines 1 - 9, to justify right the line numbers, use the <code>span</code> element with the <code>class='line-number-all line-number-justify-right-one'</code> attribute; and 2.) for lines 10 - 99, use the <code>span</code> element with the <code>class='line-number-all'</code> attribute:</p>
...
&lt;/pre&gt;
     ...
     <p>To add line numbers to a block of code having 100 - 999 lines of code: 1.) for lines 1 - 9, to justify right the line numbers, use the <code>span</code> element with the <code>class='line-number-all line-number-justify-right-two'</code> attribute; 2.) for lines 10 - 99, to justify right the line numbers, use the <code>span</code> element or <code>class='line-number-all line-number-justify-right-one'</code> attribute; and 3.) for lines 100 - 999, use the <code>span</code> element with the <code>class='line-number-all'</code> attribute:</p>
...
&lt;/pre&gt;
     ...
     <p> If there are line numbers, do not nest the line numbers within the <code>&lt;b&gt;&lt;/b&gt;</code> tags:</p>
...
&lt;/pre&gt;
     ...
     <p>To add a comment to a line or block of code, use the <code>span</code> element with the <code>class='comment'</code> attribute:</p>
...
&lt;/pre&gt;
     ...
     <p> If there are line numbers, do not nest the line numbers within the <code>&lt;span class='comment'&gt;&lt;/span&gt;</code> tags:</p>
...
<pre>
&lt;pre&gt;
if (arguments.length <b>&amp;gt;</b> 0){
 for (var i = 0; i <b>&amp;lt;</b> arguments.length; i = i + 2){
  bcrumbsNavHtmlString += <b>&amp;quot;</b> <b>&amp;amp;</b>rarr; <b>&amp;lt;</b>a href='<b>&amp;quot;</b> + arguments[i] + <b>&amp;quot;</b>index.html'<b>&amp;gt;&amp;quot;</b> + arguments[i + 1] + <b>&amp;quot;&amp;lt;</b>/a<b>&amp;gt;&amp;quot;</b>;
 }
}
&lt;/pre&gt;
</pre>

     <p>The <code>span</code> and <code>b</code> type selectors are not assigned author styles. The <code>pre</code> type selector, the <code>pre .comment</code> descendant selector, and the <code>pre > span.line-number-all::before</code>, <code>pre > span.line-number-justify-right-one::before</code>, <code>pre > span.line-number-justify-right-two::before</code>, and <code>pre > span::after</code> pseudo-element selectors are assigned author styles:</p>
...
pre > span.line-number-all::before { content: counter(line-number); counter-increment: line-number; display: inline-block; color: #777; border-right: 1px solid #ccc; padding-right: 0.5em; } <span class='comment'>/* No space before line number. Allow border-right to span entire line-height. */</span>
pre > span.line-number-justify-right-one::before { content: &quot; &quot; counter(line-number); counter-increment: line-number; } <span class='comment'>/* One space before line number (hence, justify right one). */</span>
pre > span.line-number-justify-right-two::before { content: &quot;  &quot; counter(line-number); counter-increment: line-number; } <span class='comment'>/* Two spaces before line number (hence, justify right two). */</span>
pre > span::after { content: &quot;&quot;; padding-right: 0.25em; } <span class='comment'>/* Small space between line number border-right and code. */</span>
</pre>
...
<pre>
<span class='line-number-all line-number-justify-right-one'></span>var <b>BcrumbsNavUtil</b> = {
<span class='line-number-all line-number-justify-right-one'></span> bcrumbsNav: function(){
<span class='line-number-all line-number-justify-right-one'></span>  <b>var bcrumbsNavElementReference = document.getElementById(&quot;bcrumbsNavElement&quot;);</b>
<span class='line-number-all line-number-justify-right-one'></span>  var bcrumbsNavHtmlString = &quot;&lt;a href='/index2.html'&gt;Web Site Home Page&lt;/a&gt;&quot;;
<span class='line-number-all line-number-justify-right-one'></span>  <b>if (arguments.length &gt; 0){</b>
<span class='line-number-all line-number-justify-right-one'></span>   <b>for (var i = 0; i &lt; arguments.length; i = i + 2){</b>
<span class='line-number-all line-number-justify-right-one'></span>    <b>bcrumbsNavHtmlString += &quot; &amp;rarr; &lt;a href='&quot; + arguments[i] + &quot;index.html'&gt;&quot; + arguments[i + 1] + &quot;&lt;/a&gt;&quot;;</b>
<span class='line-number-all line-number-justify-right-one'></span>   <b>}</b>
<span class='line-number-all line-number-justify-right-one'></span>  <b>}</b>
...
&lt;html lang='en'&gt;
 &lt;head&gt;
  ...
  &lt;style&gt;
   ...
   <span class='comment'>/* CSS single line comment. */</span>
   ...
   <span class='comment'>/* CSS multiple
   line comment. */</span>
   ...
  &lt;/style&gt;
 &lt;/head&gt;
 &lt;body&gt;
  ...
  <span class='comment'>&lt;-- HTML single line comment. --&gt;</span>
  ...
  <span class='comment'>&lt;-- HTML multiple
  line comment. --&gt;</span>
  ...
  &lt;script&gt;
   ...
   <span class='comment'>// JavaScript single line comment.</span>
   ...
   <span class='comment'>/* JavaScript single line comment. */</span>
   ...
   <span class='comment'>/* JavaScript multiple
   line comment. */</span>
   ...
  &lt;/script&gt;
 &lt;/body&gt;
&lt;/html&gt;
     ...
     <div class='note normal'>As opposed hard coding line numbers in HTML, line numbers via CSS <code>::before</code> and <code>::after</code> pseudo-elements prohibits inclusion of the line numbers (except IE10+) when use mouse click and drag to highlight the code for copy and paste.</div>
...
<span class='line-number-all line-number-justify-right-one'></span>  &lt;title&gt;Learn Web Coding Home Template Explained&lt;/title&gt;
<span class='line-number-all line-number-justify-right-one'></span>  &lt;meta charset='UTF-8' /&gt;
<span class='line-number-all line-number-justify-right-one'></span>  &lt;meta name='Author' content='Steve Taylor' /&gt;
<span class='line-number-all line-number-justify-right-one'></span>  &lt;meta name='Keywords' content='Learn Web Coding Home, template, explained' /&gt;
<span class='line-number-all line-number-justify-right-one'></span>  &lt;meta name='Description' content='An explanation of the Learn Web Coding Home Template.' /&gt;
<span class='line-number-all line-number-justify-right-one'></span>  &lt;meta name='viewport' content='width=device-width, initial-scale=1' /&gt;
<span class='line-number-all'></span>  &lt;style&gt;
<span class='line-number-all'></span>   ...
<span class='line-number-all'></span>   <span class='comment'>/* CSS single line comment. */</span>
<span class='line-number-all'></span>   ...
<span class='line-number-all'></span>   <span class='comment'>/* CSS multiple</span>
<span class='line-number-all'></span>   <span class='comment'>line comment. */</span>
<span class='line-number-all'></span>   ...
<span class='line-number-all'></span>  &lt;/style&gt;
<span class='line-number-all'></span> &lt;/head&gt;
<span class='line-number-all'></span> &lt;body&gt;
<span class='line-number-all'></span>  ...
<span class='line-number-all'></span>  <span class='comment'>&lt;-- HTML single line comment. --&gt;</span>
<span class='line-number-all'></span>  ...
<span class='line-number-all'></span>  <span class='comment'>&lt;-- HTML multiple</span>
<span class='line-number-all'></span>  <span class='comment'>line comment. --&gt;</span>
<span class='line-number-all'></span>  ...
<span class='line-number-all'></span>  &lt;script&gt;
<span class='line-number-all'></span>   ...
<span class='line-number-all'></span>   <span class='comment'>// JavaScript single line comment.</span>
<span class='line-number-all'></span>   ...
<span class='line-number-all'></span>   <span class='comment'>/* JavaScript single line comment. */</span>
<span class='line-number-all'></span>   ...
<span class='line-number-all'></span>   <span class='comment'>/* JavaScript multiple</span>
<span class='line-number-all'></span>   <span class='comment'>line comment. */</span>
<span class='line-number-all'></span>   ...
<span class='line-number-all'></span>  &lt;/script&gt;
<span class='line-number-all'></span> &lt;/body&gt;
...
<!-- Last reviewed/updated: 25 Jun 2016. -->
     ...
     <h3><a id='filenames'></a>27.4. Filenames, Folder/Directory Names, File System Paths, And Terminal/Command Prompt Output</h3>

<!--
1.) For folder/directory names themselves (eg, System32); 1.) in .php and .html files, use <span class='filename'>System32</span> folder without preceding backslash (\) character, and 2.) in .txt files, use \System32 folder with preceding backslash (\) character.
2.) For folder/directory names, there are cases where escaping backslash (\) character with backslash (\) character is required (eg, C:\\xampp) and there are cases where escaping backslash (\) character with backslash (\) character is not required (eg, xampp\\htdocs). Regardless, for folder/directory names always escape backslash (\) character with backslash (\) character.
-->

     <p>Filenames, folder/directory names, file system paths, and terminal/command prompt output use the <code>span</code> element with the <code>class='filename'</code> attribute:</p>
...
.filename {
  font-family: &quot;courier new&quot;, courier, monospace;
     ...
     <p>Examples of filenames, folder/directory names, file system paths, and terminal/command prompt output:</p>

     <p>The Bootstrap implementation requires loading the Bootstrap style sheet <span class='filename'>bootstrap.min.css</span> file, the jQuery JavaScript <span class='filename'>jquery-3.4.1.min.js</span> file, and the Bootstrap JavaScript <span class='filename'>bootstrap.min.js</span> file.</p>
     ...
     <p>The root of the web server is <span class='filename'>C:\\xampp\\htdocs</span>.</p>

     <p>Copy the <span class='filename'>quickinstall</span> QuickInstall software folder to the root of the web server. In this example, the <span class='filename'>quickinstall</span> QuickInstall software folder was copied to the root of XAMPP Apache as <span class='filename'>C:\\xampp\\htdocs\\quickinstall</span>.</p>

     <p>Subsequent phpBB board software to install is copied to the QuickInstall software <span class='filename'>sources\phpBB3_alt</span> directory.</p>
...
<!-- Last reviewed/updated: 25 Jun 2016. -->
     ...
     <h3><a id='computerStatusReports'></a>27.7. Computer Status Reports</h3>

     <p>Computer status reports are text that convey the error, warning, success, or miscellaneous status of a computer related operation. Use the same spelling, capitalization, and punctuation, including any ending punctuation, as the computer status report.</p>

     <p>Computer status reports use the <code>q</code> element:</p>

<pre>
&lt;p&gt;&lt;q&gt;Computer status report.&lt;q&gt;&lt;/p&gt;
</pre>

<!-- Last reviewed/updated: 03 Jan 2020. -->

     <p>Examples of computer status reports:</p>
     ...
     <p>In Compatibility View, the Internet Explorer 11.0 for Windows 10 Version 1507 32-bit user-agent string value reports <q>trident/8.0</q>, not <q>trident/7.0</q>.</p>

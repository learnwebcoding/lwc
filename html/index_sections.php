 ...
 * Last reviewed/updated: 01 Jun 2019.
...
<!-- Similar note below in /html/index_sections.php (twice) and /javascript/index_sections.php (twice). -->
     ...
     <h3><a id='w3cHtml32'></a>3.2. W3C HTML 3.2, 4.0, And 4.01 Recommendations</h3>
     ...
     <ul class='link-list'>
      <li><a href='http://www.w3.org/TR/2010/REC-xhtml11-20101123/'>XHTML 1.1 - Module-Based XHTML - Second Edition: W3C Recommendation 23 November 2010 (w3.org)</a></li>
      ...
      <li><a href='http://www.w3.org/MarkUp/2004/xhtml-faq'>HTML And XHTML Frequently Answered Questions (w3.org)</a></li>
     </ul>
...
-->
     ...
     <h4><a id='w3cHtml5wd'></a>3.4.3. W3C HTML5 Working Drafts</h4>

     <ul class='link-list'>
      <li><a href='http://www.w3.org/TR/microdata/'>HTML Microdata: W3C Working Draft 26 June 2017 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/html-aam-1.0/'>HTML Accessibility API Mappings 1.0: W3C Working Draft 06 June 2017 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/using-aria/'>Using ARIA: W3C Working Draft 04 May 2017 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/html-aria/'>ARIA In HTML: W3C Working Draft 23 March 2017 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/html-imports/'>HTML Imports: W3C Working Draft 25 February 2016 (w3.org)</a></li>
     </ul>
...
<!-- W3C RDFa Working Group: http://www.w3.org/2010/02/rdfa/ -->
     ...
     <ul class='link-list'>
      <li><a href='http://www.w3.org/TR/html-rdfa/'>HTML+RDFa 1.1 - Second Edition: Support For RDFa In HTML4 And HTML5: W3C Recommendation 17 March 2015 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/xhtml-rdfa/'>XHTML+RDFa 1.1 - Third Edition: Support For RDFa Via XHTML Modularization: W3C Recommendation 17 March 2015 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/rdfa-core/'>RDFa Core 1.1 - Third Edition: Syntax And Processing Rules For Embedding RDF Through Attributes: W3C Recommendation 17 March 2015 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/rdfa-lite/'>RDFa Lite 1.1 - Second Edition: W3C Recommendation 17 March 2015 (w3.org)</a></li>
     </ul>

     <h4><a id='w3cRdfaWgn'></a>3.5.2. W3C RDFa Working Group Notes</h4>

     <ul class='link-list'>
      <li><a href='http://www.w3.org/TR/rdfa-primer/'>RDFa 1.1 Primer - Third Edition: Rich Structured Data Markup For Web Documents: W3C Working Group Note 17 March 2015 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/rdfa-api/'>RDFa API: An API For Extracting Structured Data From Web Documents: W3C Working Group Note 05 July 2012 (w3.org)</a></li>
     </ul>
    ...
    <section>
     ...
     <ul class='link-list'>
      ...
      <li><a href='http://www.w3.org/International/tutorials/tutorial-char-enc/'>Handling Character Encodings In HTML And CSS (w3.org)</a></li>
      <li><a href='http://www.utf-8.com/'>UTF-8 And Unicode (utf-8.com)</a></li>
      <li><a href='http://www.w3.org/TR/xml-entity-names/bycodes.html'>Characters Ordered By Unicode (w3.org)</a></li>
      <li><a href='https://dev.w3.org/html5/html-author/charref'>Character Entity Reference Chart (dev.w3.org)</a></li>
      <li><a href='http://unicodelookup.com/'>Unicode Lookup (unicodelookup.com)</a></li>
      <li><a href='http://www.babelstone.co.uk/Unicode/index.html'>BabelStone: Unicode: Javascript Unicode Tools (babelstone.co.uk)</a></li>
      <li><a href='http://www.fileformat.info/'>FileFormat.Info</a></li>
      <li><a href='http://viewportsizes.com/'>Viewport Sizes (viewportsizes.com)</a></li>
      <li><a href='https://msdn.microsoft.com/en-us/library/ms537512(v=vs.85).aspx'>About Conditional Comments (msdn.microsoft.com)</a></li>
      <li><a href='http://www.w3.org/TR/webarch/'>Architecture Of The World Wide Web, Volume One: W3C Recommendation 15 December 2004 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/i18n-html-tech-lang/'>Authoring HTML: Language Declarations: W3C Working Group Note 03 June 2014 (w3.org)</a></li>
      <li><a href='http://www.w3.org/TR/i18n-html-tech-bidi/'>Authoring HTML: Handling Right-To-Left Scripts: W3C Working Group Note 03 June 2014 (w3.org)</a></li>
     </ul>

...
return
   "<section>
    ...
    <section>
     ...
     <ul class='link-list'>
      ...
      <li><a href='/css/css_techniques/index.php'>CSS Techniques (learnwebcoding.com)</a>
       <ul class='link-list'>
        <li><a href='/css/css_techniques/style_textboxes_textareas.php'>Style Textboxes And Textareas (learnwebcoding.com)</a></li>
        <li><a href='/css/css_techniques/style_selectboxes.php'>Style Selectboxes (learnwebcoding.com)</a></li>
        <li><a href='/css/css_techniques/style_checkboxes_radio_buttons.php'>Style Checkboxes And Radio Buttons (learnwebcoding.com)</a></li>
        <li><a href='/css/css_techniques/reveal_fixed_footer_upon_scrolling.php'>CSS Technique: Reveal Fixed Web Page Footer Upon Scrolling</a></li>
       </ul>
      </li>
    ...
    <section>
     ...
     <h2><a id='javascript'></a>3. JavaScript</h2>
    ...
    <section>
     ...
     <h2><a id='php'></a>4. PHP</h2>

     <ul class='link-list'>
      <li><a href='/php/simple_mysql_admin.php'>Simple MySQL Admin (learnwebcoding.com)</a></li>
      <li><a href='/php/install_quickinstall_windows.php'>Install phpBB QuickInstall On Your Local Windows Web Server To Develop phpBB Board Styles (learnwebcoding.com)</a></li>
     </ul>
